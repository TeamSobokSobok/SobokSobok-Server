...
//                .where(
//                        pill.userId.eq(userId),
//                        pillSchedule.scheduleDate.eq(date)
//                )
//                .fetch();
//        List<DateScheduleResponse> dateScheduleResponses = new ArrayList<>();
//
//        for (String time : pillScheduleTimeList) {
//            List<Long> stickerIdList = queryFactory
//                    .select(likeSchedule.stickerId)
//                    .from(pillSchedule)
//                    .leftJoin(pill).on(pill.id.eq(pillSchedule.pillId))
//                    .leftJoin(likeSchedule).on(likeSchedule.scheduleId.eq(pillSchedule.id))
//                    .leftJoin(sticker).on(sticker.id.eq(likeSchedule.stickerId))
//                    .where(
//                            pill.userId.eq(userId),
//                            pillSchedule.scheduleDate.eq(date),
//                            pillSchedule.scheduleTime.eq(time)
//                    )
//                    .fetch();
//
//            stickerIdList = stickerIdList.stream()
//                    .filter(Objects::nonNull)
//                    .collect(Collectors.toList());
//
//            if (stickerIdList.isEmpty()) {
//                stickerIdList = Collections.emptyList();
//            }
//
//            List<Tuple> result = queryFactory
//                    .select(
//                            pillSchedule.id.as("scheduleId"),
//                            pill.id.as("pillId"),
//                            pill.pillName,
//                            pillSchedule.isCheck,
//                            pill.color,
//                            likeSchedule.scheduleId.count().as("stickerTotalCount")
//
//                    )
//                    .from(pillSchedule)
//                    .leftJoin(pill).on(pill.id.eq(pillSchedule.pillId))
...
//                    .fetch();
//
//            List<Long> finalStickerIdList = stickerIdList;
//            List<PillScheduleInfo> pillScheduleInfoList = result.stream()
//                    .map(t -> {
//                        return PillScheduleInfo.builder()
//                                .scheduleId(t.get(0, Long.class))
//                                .pillId(t.get(1, Long.class))
//                                .pillName(t.get(2, String.class))
//                                .isCheck(t.get(3, Boolean.class))
//                                .color(t.get(4, Integer.class))
//                                .stickerId(finalStickerIdList)
//                                .stickerTotalCount(t.get(5, Long.class))
//                                .build();
//                    })
//                    .toList();
//
//            dateScheduleResponses.add(
//                    DateScheduleResponse.builder()
//                            .scheduleTime(time)
//                            .scheduleList(pillScheduleInfoList)
//                            .build()
//            );
//        }
//
